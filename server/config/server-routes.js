...
module.exports = (app) => {
  ...
  // Graphs
  app.post('/api/graph/add', authCheck, controllers.graph.add)
  app.get('/api/graph/:graphId', authCheck, controllers.graph.get)
  app.get('/api/graphs/all', authCheck, controllers.graph.all.get)
  app.get('/api/graphs/total', controllers.graph.total.get)
  app.get('/api/graphs/page', controllers.graph.page.get)
  app.get('/api/graphs/category/:category', authCheck, controllers.graph.category.get)
  app.post('/api/graph/comments/:graphId', authCheck, controllers.graph.commentGraph)
